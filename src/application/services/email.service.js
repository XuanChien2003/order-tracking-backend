...
async function sendPartnerCredentialsEmail({ to, companyName, username, password }) {
  ...
  const html = `
    ...
    <p>Quản trị viên đã tạo tài khoản đối tác cho bạn trên hệ thống New Horizon Logistics. Thông tin đăng nhập:</p>
    <ul>
