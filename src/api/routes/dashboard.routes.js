 ...
 *     responses:
 *       200:
 *         description: Thống kê (partner chỉ thấy đơn của mình, admin toàn hệ thống). Riêng admin có thêm `scanStats` (tổng lượt quét theo loại sự kiện + nhật ký các lượt quét gần nhất); partner nhận `scanStats: null`
 *       401:
